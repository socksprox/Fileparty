(function (deckyFrontendLib, React) {
  ...
  const Content = ({ serverAPI }) => {
      ...
      return (window.SP_REACT.createElement(deckyFrontendLib.PanelSection, null,
          ...
          window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
              window.SP_REACT.createElement(deckyFrontendLib.TextField, { label: "Password for user Webinterface", description: "This should not be your sudo password!", value: password, onChange: onPasswordChange })),
          window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
